...
cd /home/jupyter-jspies/Ergebnisse/$input/BLAST/Crass
...
' blacklisted_spacers.txt | sort -u > /home/jupyter-jspies/Ergebnisse/$input/Blasted_Groups.txt
...
conda run -n seqkit_env seqkit grep -w 0 -v -r -f /home/jupyter-jspies/Ergebnisse/$input/Blasted_Groups.txt /home/jupyter-jspies/Ergebnisse/$input/repeats_und_spacer/crass_R1_und_R2.fasta > /home/jupyter-jspies/Ergebnisse/$input/BLAST/Crass/CRISPR_Blast_filtered_sequences.fasta
...
' /home/jupyter-jspies/Ergebnisse/$input/BLAST/Crass/CRISPR_Blast_filtered_sequences.fasta > /home/jupyter-jspies/Ergebnisse/$input/CRISPRclassify/Crass_blasted/repeats_R1_und_R2.fasta

awk 'NR%2==0 {print $1}
' /home/jupyter-jspies/Ergebnisse/$input/CRISPRclassify/Crass_blasted/repeats_R1_und_R2.fasta > /home/jupyter-jspies/Ergebnisse/$input/CRISPRclassify/Crass_blasted/repeats_crass_blasted.txt
