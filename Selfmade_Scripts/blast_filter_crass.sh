...
conda run -n seqkit_env seqkit grep -w 0 -v -r -f /home/jupyter-jspies/Groups.txt /home/jupyter-jspies/Ergebnisse/$input/repeats_und_spacer/crass_R1_und_R2.fasta > /home/jupyter-jspies/Ergebnisse/$input/BLAST/Crass/CRISPR_Blast_filtered_sequences.fasta
