...
The scripts are intended to be used within the context of the full pipeline described in the associated thesis. Individual scripts may require specific input formats and dependencies.
